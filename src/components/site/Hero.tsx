...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-end overflow-hidden">
      ...
      <div ref={contentRef} className="relative container-wide pt-40 pb-24 text-primary-foreground will-change-transform">
        <div className="max-w-3xl" data-reveal>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a href="#contact" className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-primary-foreground font-medium shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-glow)] hover:-translate-y-0.5 transition-all duration-300" style={{ background: "var(--gradient-warm)" }}>
            ...
            <a href="tel:+919967980747" className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full border border-primary-foreground/40 text-primary-foreground hover:bg-primary-foreground/10 backdrop-blur-sm hover:-translate-y-0.5 transition-all duration-300">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-primary-foreground/70 text-xs tracking-[0.3em] uppercase flex flex-col items-center gap-2 animate-pulse">
        Scroll
        <span className="w-px h-10 bg-primary-foreground/40" />
      </div>
    </section>
  );
};
